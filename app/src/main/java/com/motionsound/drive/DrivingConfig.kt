...
object DrivingConfig {
    ...
    const val ACCEL_A_ENTER = 0.9f
    const val ACCEL_A_EXIT = 0.5f
    ...
    const val CORNER_VOL_RELEASE = 0.10f
    const val VOL_SMOOTH_ATTACK = 0.3f
    const val VOL_SMOOTH_RELEASE = 0.12f
